<div class="editorial__detail__header <?php add_billboard_class(); ?>">
  <?php $image = get_field('background_image'); write_log($image); if($image): $size = 'large-feature'; ?>
    <div class="billboard__image" style="background-image:<?php echo cc_background_image_filter(); ?>, url('<?php echo $image["sizes"]["large-feature"]; ?>')"></div>
  <?php else: ?>
    <div class="billboard__image" style="background-image:<?php echo cc_background_image_filter(); ?>, url('<?php echo the_post_thumbnail_url('large-feature'); ?>')"></div>  <?php endif; ?>
